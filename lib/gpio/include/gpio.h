 ...
 *         "GPIO_v_SetUpPin" -> "REG_v_ClearBit": Disable pull-up resistor
 *         activate "REG_v_ClearBit"
 *         "REG_v_ClearBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_ClearBit"
 *         "GPIO_v_SetUpPin" -> "REG_v_SetBit": Set pin direction as output
 *         activate "REG_v_SetBit"
 *         "REG_v_SetBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_SetBit"
 *       else Pin direction is not output
 *         Note over "GPIO_v_SetUpPin": Set pin as input
 *         "GPIO_v_SetUpPin" -> "REG_v_ClearBit": Set pin direction as input
 *         activate "REG_v_ClearBit"
 *         "REG_v_ClearBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_ClearBit"
 *       end
 ...
 *         "REG_v_ClearBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_ClearBit"
 *         "GPIO_v_SetUpPin" -> "REG_v_SetBit": Enable primary function select
 *         activate "REG_v_SetBit"
 *         "REG_v_SetBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_SetBit"
 *       else e_funSel equals secondary
 *         "GPIO_v_SetUpPin" -> "REG_v_SetBit": Enable secondary function select
 *         activate "REG_v_SetBit"
 *         "REG_v_SetBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_SetBit"
 *         "GPIO_v_SetUpPin" -> "REG_v_SetBit": Enable primary function select
 ...
 *         deactivate "REG_v_SetBit"
 *       else
 *         "GPIO_v_SetUpPin" -> "REG_v_ClearBit": Disable secondary function select
 *         activate "REG_v_ClearBit"
 *         "REG_v_ClearBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_ClearBit"
 *         "GPIO_v_SetUpPin" -> "REG_v_ClearBit": Disable primary function select
 *         activate "REG_v_ClearBit"
 *         "REG_v_ClearBit" --> "GPIO_v_SetUpPin"
 *         deactivate "REG_v_ClearBit"
 *       end
 ...
 *      alt e_ren is enable
 *        GPIO_v_ResConf -> REG_v_SetBit: Enable pull-up resistor
 *        REG_v_SetBit --> GPIO_v_ResConf
 *      else e_ren is not enable
 *        GPIO_v_ResConf -> REG_v_ClearBit: Disable pull-up resistor
 *        REG_v_ClearBit --> GPIO_v_ResConf
 *      end
 *      alt e_resType is pullUp
 *        GPIO_v_ResConf -> REG_v_SetBit: Set pin output high for pull-up
 *        REG_v_SetBit --> GPIO_v_ResConf
 *      else e_resType is not pullUp
 *        GPIO_v_ResConf -> REG_v_ClearBit: Set pin output low for pull-down
 *        REG_v_ClearBit --> GPIO_v_ResConf
 *      end
 ...
 *    au_portPinStat --> GPIO_t_ReadPin
 *    alt Pin direction is input?
 *      GPIO_t_ReadPin -> REG_u_ReadBit: Read pin state
 *      REG_u_ReadBit --> GPIO_t_ReadPin
 *      deactivate REG_u_ReadBit
 ...
 * \callgraph
 * \startuml
 *  GPIO_v_WritePin -> REG_u_ReadBit : Read pin direction
 *  REG_u_ReadBit --> GPIO_v_WritePin : Pin direction value
 *  activate REG_u_ReadBit
 *  alt Pin direction equals output
 *  GPIO_v_WritePin -> REG_v_SetBit : Set pin state
 *  REG_v_SetBit --> GPIO_v_WritePin : Pin state set
 *  deactivate REG_v_SetBit
